-- Project CR Tasks Seeding Script
-- Based on Luminary Co. Startup Documentation & Work Plan
-- This script populates the deliverables table with all Project CR tasks

-- Clear existing deliverables (if any)
DELETE FROM deliverables;

-- Week 1: Strategic Foundation (Oct 1-7)
...
-- Week 2: Digital Presence & Systems (Oct 8-14)
INSERT INTO deliverables (title, description, status, project_area, week_number, due_date, progress) VALUES
...
-- Week 3: HR & Internal Systems (Oct 15-21)
INSERT INTO deliverables (title, description, status, project_area, week_number, due_date, progress) VALUES
...
-- Week 4: Client-Ready Launch (Oct 22-31)
INSERT INTO deliverables (title, description, status, project_area, week_number, due_date, progress) VALUES
...
-- Additional Supporting Documents (Throughout 4 weeks)
INSERT INTO deliverables (title, description, status, project_area, week_number, due_date, progress) VALUES

-- Operations & Systems Supporting Documents
...
-- Finance & Administration Supporting Documents
...
-- Social Media & Marketing Supporting Documents
...
-- Update project phases status
UPDATE project_phases SET status = 'not-started' WHERE id IN (
  SELECT id FROM project_phases WHERE name LIKE 'Week 1:%'
);

-- Set Week 1 as current phase
UPDATE project_phases SET status = 'in-progress' WHERE name = 'Week 1: Strategic Foundation';
